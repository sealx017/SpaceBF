#' @title Function for the NB fused model with HS prior
#'
...
NB_model <-function(y1, y2, X = NULL, G, nIter = 5000, beta_thres = 10, 
  ...
  G[lower.tri(G)] = 0
  sorted_indices <- which(G == 1, arr.ind = T)          # indices of non-zero elements of the upper triangle of the G matrix
