...
We are fitting the NB model this time with an ICAR prior (which.prior = "ICAR"). The arguments are the same as before, except that *G* now denotes the Delauney network constructed using the MERINGUE package.


```{r fit SpaceBF NB model with ICAR, echo = T, results = T}
...
```{r compare HS vs. ICAR, echo = T, results = T}
