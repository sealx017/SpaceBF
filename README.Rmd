...
```{r fit SpaceBF NB model, echo = T, results = T}
MM_ICAR <- SpaceBF(y1, y2, X = NULL, G = w, which.model = "NB", which.prior = "ICAR", nIter = 5000)  # decrease nIter for quicker results
