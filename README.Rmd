...
We are fitting the NB model this time with an ICAR prior (which.prior = "ICAR"). The rest of the argumentsare the same as before, except that *G* now denotes the Delauney network constructed using the MERINGUE package.
