...
```{r p-value visualization,  out.width="80%"}
...
```{r fit SpaceBF NB model with ICAR, echo = T, results = T, out.width="80%"}
...
```{r compare HS vs. ICAR, echo = T, results = T, out.width="80%"}
...
```{r fit SpaceBF NB model with horseshoe on Delaunay, echo = T, results = T, out.width="80%"}
...
```{r compare HS MST vs. HS Delaunay vs. ICAR, echo = T, results = T, out.width="80%"}
